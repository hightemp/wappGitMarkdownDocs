...
// Webpack 5 (asset/source) может возвращать строку либо как модуль с default export,
// либо напрямую строкой — нормализуем оба варианта.
function normalizeAssetSourceModule(oModule)
{
    return (oModule && typeof oModule === 'object' && oModule.default) ? oModule.default : oModule;
}

CodeMirrorSpellChecker.aff_data = {
    en_US: normalizeAssetSourceModule(require("../data/en_US.aff")),
    ru_RU: normalizeAssetSourceModule(require("../data/ru_RU.aff"))
};
CodeMirrorSpellChecker.dic_data = {
    en_US: normalizeAssetSourceModule(require("../data/en_US.dic")),
    ru_RU: normalizeAssetSourceModule(require("../data/ru_RU.dic"))
};
